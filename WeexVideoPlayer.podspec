...
weex视频流播放插件,并边下边播
  ...
  spec.homepage     = "https://github.com/jiejieshow1/WeexVideoPlayerSDK"
  ...
  spec.author             = { "alan" => "jiejieshow@hotmail.com" }
  # Or just: spec.author    = "alan"
  # spec.authors            = { "alan" => "jiejieshow@hotmail.com" }
  ...
  spec.source       = { :git => "https://github.com/jiejieshow1/WeexVideoPlayerSDK.git", :tag => "0.0.1" }
